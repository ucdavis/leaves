...
{
    /// <inheritdoc />
    public partial class AddEmployeeAccrualBalances : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_EmployeeAccrualBalances", x => new { x.EmployeeId, x.AsOfDate, x.PositionNumber, x.LeaveTypeNumber });
                });

            migrationBuilder.CreateIndex(
                name: "IX_EmployeeAccrualBalances_AsOf_Employee_LeaveType",
                schema: "dbo",
                table: "EmployeeAccrualBalances",
                columns: new[] { "AsOfDate", "EmployeeId", "LeaveTypeNumber" });

            migrationBuilder.CreateIndex(
                name: "IX_EmployeeAccrualBalances_EmployeeId",
                schema: "dbo",
                table: "EmployeeAccrualBalances",
                column: "EmployeeId");
        }
