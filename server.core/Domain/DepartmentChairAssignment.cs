...
public class DepartmentChairAssignment
{
    [Key]
    ...
    public static void Configure(EntityTypeBuilder<DepartmentChairAssignment> entity)
    {
        entity.HasKey(e => e.Id);
        entity.Property(e => e.Id).ValueGeneratedOnAdd();

        entity.HasIndex(e => new { e.DepartmentCode, e.EffectiveStartDate, e.EffectiveEndDateExclusive })
