...
public class Person
{
    ...
    public static void Configure(EntityTypeBuilder<Person> entity)
    {
        ...
        entity.Property(e => e.FirstName).HasColumnType("varchar(64)").HasMaxLength(64);
        entity.Property(e => e.MiddleName).HasColumnType("varchar(64)").HasMaxLength(64);
        entity.Property(e => e.LastName).HasColumnType("varchar(64)").HasMaxLength(64);
        entity.Property(e => e.Suffix).HasColumnType("varchar(16)").HasMaxLength(16);
        entity.Property(e => e.FullName).HasColumnType("varchar(128)").HasMaxLength(128);
        entity.Property(e => e.Pronouns).HasColumnType("varchar(64)").HasMaxLength(64);
